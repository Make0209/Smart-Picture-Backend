 ...
 * 创建扩图任务请求参数封装类
 */
@Schema(description = "创建图像任务请求参数封装类")
@Data
public class CreateOutPaintingTaskRequest implements Serializable {

    @Serial
    private static final long serialVersionUID = -5291124121662634327L;
    ...
    public static class Parameters implements Serializable {
        @Serial
        private static final long serialVersionUID = 2513481839474577851L;

        /**
         * 可选，逆时针旋转角度，默认值 0，取值范围 [0, 359]
         */
        @Schema(description = "可选，逆时针旋转角度，默认值 0，取值范围 [0, 359]")
