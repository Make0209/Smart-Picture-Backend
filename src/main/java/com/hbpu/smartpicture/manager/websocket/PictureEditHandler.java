...
import com.hbpu.smartpicture.manager.websocket.disruptor.PictureEditEventProducer;
import com.hbpu.smartpicture.manager.websocket.model.PictureEditActionEnum;
import com.hbpu.smartpicture.manager.websocket.model.PictureEditMessageTypeEnum;
import com.hbpu.smartpicture.manager.websocket.model.PictureEditRequestMessage;
import com.hbpu.smartpicture.manager.websocket.model.PictureEditResponseMessage;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(@NonNull WebSocketSession session, @NonNull TextMessage message) throws Exception {
        ...
        PictureEditRequestMessage pictureEditRequestMessage = JSONUtil.toBean(
                message.getPayload(), PictureEditRequestMessage.class);
     ...
     * 进入编辑状态
     *
     * @param pictureEditRequestMessage 消息内容
     * @param session                   当前会话
     * @param user                      当前用户
     ...
     *
     * @param pictureId                  图片 ID
     * @param pictureEditResponseMessage 消息内容
