...
public abstract class PictureUploadTemplate {
    ...
    public UploadPictureResultDTO uploadPicture(Object inputSource, String folderPath) {
        ...
        String fileName = LocalDate.now() + uuid;
        ...
        // 获取图片处理信息
        List<CIObject> processedPic = putObjectResult.getCiUploadResult().getProcessResults().getObjectList();
    ...
    private UploadPictureResultDTO bulidResult(CIObject compressedObject, String fileName) {
        ...
        uploadPictureResultDTO.setUrl("https://" + compressedObject.getLocation());
        uploadPictureResultDTO.setName(fileName);
        uploadPictureResultDTO.setPicSize(Long.valueOf(compressedObject.getSize()));
