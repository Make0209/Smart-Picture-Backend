...
public class StpInterfaceImpl implements StpInterface {
    ...
    public StpInterfaceImpl(SpaceUserAuthManager spaceUserAuthManager, SpaceUserService spaceUserService, PictureService pictureService, UserService userService, SpaceService spaceService) {
    ...
    private SpaceUserAuthContext getAuthContextByRequest() {
        ...
        if (ContentType.JSON.getValue().equals(contentType)) {
            // 使用原生方法读取请求体，兼容 jakarta.servlet
            String body = readRequestBody(request);
            authRequest = JSONUtil.toBean(body, SpaceUserAuthContext.class);
        } else {
            // 使用 request.getParameterMap() 替代 ServletUtil.getParamMap()，兼容 jakarta.servlet
    ...
    /**
     * 读取请求体内容（兼容 jakarta.servlet）
     * <p>
     * 替代 Hutool 的 ServletUtil.getBody()，因为该方法使用 javax.servlet 不兼容
     */
